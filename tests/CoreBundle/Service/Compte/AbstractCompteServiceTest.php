...
/**
 * AbstractCompteServiceTest class file
 *
 * PHP Version 5.6
 *
 * @category Test
...
/**
 * AbstractCompteServiceTest class
 *
 * @category Test
 * @author   Guillaume ORAIN <guillaume.orain27@laposte.net>
 */
class AbstractCompteServiceTest extends AbstractMasterService
{
    /**
     ...
     * @covers AbstractCompteService::getTypeCompte
     */
     ...
     * supérieur à 0
     * @param CompteService $service
     * @covers AbstractCompteService::addNbTicket
     * @depends testVideService
     */
     ...
     * @depends testVideService
     * @param CompteService $service
     * @covers AbstractCompteService::isCompteActif
     */
     ...
     * @depends testVideService
     * @param CompteService $service
     * @covers AbstractCompteService::isAutoriseAuxAjustements
     */
     ...
     * @param CompteService $service
     * @depends testVideService
     * @covers AbstractCompteService::setNouveauSolde
     */
